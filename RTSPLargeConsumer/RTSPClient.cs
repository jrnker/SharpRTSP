...
namespace RtspClientExample
{
    class RTSPClient
    {
        ...
        internal enum RTSP_STATUS { WaitingToConnect, Connecting, ConnectFailed, Connected };
        ...
        public RTSP_STATUS GetSocketStatus()
        {
            return rtsp_socket_status;
        }
        public bool GetSocketConnected()
        {
            return rtsp_socket == null ? false: rtsp_socket.Connected;
        }
